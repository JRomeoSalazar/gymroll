...
function joints_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    // adding jQuery Cookie script file in the footer
    wp_enqueue_script( 'jquery-cookie', get_template_directory_uri() . '/bower_components/jquery.cookie/jquery.cookie.js', array( 'jquery' ), '', true );
    
    // adding CookieCuttr script file in the footer
    wp_enqueue_script( 'cookie-cuttr-js', get_template_directory_uri() . '/library/js/vendor/jquery.cookiecuttr.js', array( 'jquery' ), '', true );
    
    // adding blueimp-gallery script file in the footer
    wp_enqueue_script( 'blueimp-gallery-js', get_template_directory_uri() . '/bower_components/blueimp-gallery/js/blueimp-gallery.min.js', array(), '', true );
    ...
    wp_enqueue_style( 'webicons', get_template_directory_uri() . '/library/css/webicons.css', array(), $theme_version, 'all' );
    
    // register CookieCuttr stylesheet
    wp_enqueue_style( 'cookie-cuttr-css', get_template_directory_uri() . '/library/css/cookiecuttr.css', array(), '', 'all' );

    // register blueimp gallery styles
    wp_enqueue_style( 'blueimp-gallery-css', get_template_directory_uri() . '/bower_components/blueimp-gallery/css/blueimp-gallery.min.css', array(), '', 'all' );
